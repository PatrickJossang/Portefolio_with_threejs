                    ...
                    <div className="-mx-4 flex flex-wrap items-center">
                        ...
                        <div className="w-full px-4 lg:w-5/12 xl:w-4/12">
                            <div className="wow fadeInUp rounded-lg bg-white py-10 px-8 shadow-testimonial sm:py-12 sm:px-10 md:p-[60px] lg:p-10 lg:py-12 lg:px-10 2xl:p-[60px]" >
                                ...
                                <form action="/somwhere" method="post">
                                    <div className="mb-6">
                                        <label for="first name" className="block text-xs text-dark">Full Name*</label>
                                        <input
                                            type="text"
                                            id="fullName"
                                            name="fullName"
                                    ...
                                    <div>
                                        <button href='#' className='button w-40 h-16 bg-blue-500  cursor-pointer select-none active:translate-y-2  active:[box-shadow:0_0px_0_0_#1b6ff8,0_0px_0_0_#1b70f841] active:border-b-[0px] transition-all duration-150 [box-shadow:0_10px_0_0_#1b6ff8,0_15px_0_0_#1b70f841] rounded-full  border-[1px] border-blue-400 
                                '>

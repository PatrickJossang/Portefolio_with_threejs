                                ...
                                <div className="items-center justify-between overflow-hidden border lg:flex">
                                    <div className="w-full py-12 px-7 sm:px-12 md:p-16 lg:max-w-[565px] lg:py-9 lg:px-16 xl:max-w-[640px] xl:p-[70px]">
                                        ...
                                        <p className="mb-9 text-base leading-relaxed text-body-color">
                                            I love programming and design so want go try new tings and aim high
                                            I still need practis before i fully understand what i am doing but
                                            i have manage to get out of the DOOM of youtube ' the stage where
                                            you need youtube to understand'
                                        </p>
                                        <p className="mb-9 text-base leading-relaxed text-body-color">
                                            My main focus for now is to study futher in to django for backend
                                            and using react more so i can develop a more usefull understanding
                                            of the programms
                                        </p>
                                        <a
